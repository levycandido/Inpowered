...
public class StringFilter extends Filter<String> {
     ...
     */
    public StringFilter(final String value) {
        super();
        setEquals(value);
    }
    ...
    public StringFilter(final StringFilter filter) {
        super(filter);
        this.contains = urlDecode(filter.contains);
        this.doesNotContain = urlDecode(filter.doesNotContain);
    }
    ...
    public StringFilter setContains(String contains) {
        this.contains = urlDecode(contains);
        return this;
    }
    ...
    public StringFilter setDoesNotContain(String doesNotContain) {
        this.doesNotContain = urlDecode(doesNotContain);
        return this;
    }
    ...
    public StringFilter setEquals(String equals) {
        super.setEquals(urlDecode(equals));
        return this;
    }
     ...
     */
    @Override
    public Filter<String> setIn(List<String> in) {
        super.setIn(in.stream().map(this::urlDecode).collect(Collectors.toList()));
        return this;
    }
     ...
     */
    @Override
    public Filter<String> setNotIn(List<String> in) {
        super.setNotIn(in.stream().map(this::urlDecode).collect(Collectors.toList()));
        return this;
    }
